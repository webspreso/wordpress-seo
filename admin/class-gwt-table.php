...
class Example_List_Table extends WP_List_Table {
    ...
    function column_default($item, $column_name){
        switch($column_name){
			...
			case 'date_detected':
			case 'updated':
					$a = date('Y/m/d', strtotime ($item[$column_name]) );
					return $a;
    ...
    function prepare_items($mydata) {
        ...
        function usort_reorder($a,$b){
            $orderby = (!empty($_REQUEST['orderby'])) ? $_REQUEST['orderby'] : 'url'; //If no sort, default to url
 ...
 */
function tt_add_menu_items2(){
    add_menu_page('Example Plugin List Table', 'List Table Example', 'activate_plugins', 'tt_list_test', 'tt_render_list_page2');
} add_action('admin_menu', 'tt_add_menu_items2');
